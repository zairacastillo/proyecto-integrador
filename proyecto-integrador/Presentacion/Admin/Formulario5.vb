        ...
        Else
            ...
            If ask = DialogResult.Yes Then
                ...
                If (System.IO.File.Exists(destinationPathFile)) Then
                    DGV1.Rows(numRow).Cells(5).Value = Image.FromFile(destinationPathFile)
                Else
                    'sino, tomamos avatar por defecto
                    DGV1.Rows(numRow).Cells(5).Value = My.Resources.avatar
                End If
                DGV1.Rows(numRow).Cells(6).Value = destinationPathFile 'Ruta del archivo destino
